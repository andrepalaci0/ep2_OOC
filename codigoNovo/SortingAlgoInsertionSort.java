public class SortingAlgoInsertionSort implements SortingAlgoStrategy {
    public int particiona(int ini, int fim) {
        return -1; // esse metodo nao eh util pro insertionSort entao ele so retorna inválido? nao
                   // sei se isso eh valido no strategy
        // mas teoricamente esse metodo nem deveria ser usado. Pensando em talvez tornar
